...
{
    /// <summary>
    /// Serves as a handler for upgrades after being registered, mostly to sort them
    /// and identify them. Make a child of this class to create your own handlers
    /// </summary>
    // ReSharper disable once ClassWithVirtualMembersNeverInherited.Global
    public class UpgradeHandler : IHandler<UpgradeHandler>
    {
        // TODO: Finish this
        
        //+ HANDLING
        /// <inheritdoc />
        public virtual UpgradeHandler Setup()
        {
